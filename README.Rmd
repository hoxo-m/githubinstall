...
You can install packages that are available on CRAN using `install.packages()`.
...
For instance, you can install **dplyr** from the [pull request #3274](https://github.com/hadley/dplyr/pull/3274) as follows:
